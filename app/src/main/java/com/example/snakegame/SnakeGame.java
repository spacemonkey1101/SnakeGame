...
public class SnakeGame extends SurfaceView implements Runnable {
    ...
    private long mNextFrameTime; // to keep track of when to call update methods
    ...
    public SnakeGame(Context context, Point point) {
        super(context);
        //How many pixels each block is?
        int blockSize = point.x / NUM_BLOCKS_WIDE;
        //How many blocks of same size will fit into the height?
        mNumBlocksHigh = point.y / blockSize;
    ...
    public void update() {
        ...
        if(mSnake.eatenApple(mApple.getLocation())){
            mApple.spawn();
            // Add to  mScore
            mScore = mScore + 1;
            // Play a sound
